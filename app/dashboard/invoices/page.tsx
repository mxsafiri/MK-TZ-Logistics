    ...
    <DashboardShell user={user}>
      ...
      <div className="glass-card rounded-xl p-16 flex flex-col items-center justify-center text-center gap-4">
        <div className="icon-glow-purple rounded-2xl p-5">
          <FileTextIcon className="h-10 w-10 text-primary-500 dark:text-primary-400" />
        </div>
        <div>
          <h2 className="text-lg font-semibold">Invoice Generation — Coming Soon</h2>
          <p className="mt-2 max-w-md text-sm text-muted-foreground leading-relaxed">
            Create, send, and track invoices for your trips. You&apos;ll be able to generate
            PDF invoices per trip or batch, and track payment status automatically.
          </p>
        </div>
      </div>
    </DashboardShell>
